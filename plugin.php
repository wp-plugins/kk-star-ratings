...
if(!class_exists('BhittaniPlugin')) :
	...
	class BhittaniPlugin
	{
		...
		* Return: void
		*/
		protected function enqueue_js($slug, $file, $ver = '0.1', $prerequisite=false, $params=false, $footer = false, $json = false)
		{
		...
		* Return: void
		*/
		protected function enqueue_css($slug, $file, $ver = '0.1')
		{
